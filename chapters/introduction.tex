...
The recognition of human emotions from facial expressions has been a subject of scientific inquiry since the pioneering work of Paul Ekman in the 1970s \cite{ekman1971constants}. Ekman's research established that six basic emotions are universally expressed and recognized across cultures: happiness, sadness, anger, fear, disgust, and surprise. Building on this foundation, modern emotion recognition systems often include a seventh category, neutral, to represent the absence of strong emotional expression. This foundational work has enabled the development of computational systems capable of automatically detecting these emotional states from facial images and video.
