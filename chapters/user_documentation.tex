...
\begin{itemize}
    ...
    \item \textbf{Content Creators}: Video producers and marketers who want to analyze the emotional impact of their content.
...
git clone https://github.com/idafoh/bsc-thesis.git
cd bsc-thesis
\end{lstlisting}
...
\hline
DATABASE\_URL & Database connection URL & (see below) \\
\hline
...
\noindent\textbf{Note:} The default value for \texttt{DATABASE\_URL} is \texttt{sqlite+aiosqlite:///./emotion\_detection.db}
